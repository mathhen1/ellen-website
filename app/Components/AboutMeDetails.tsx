const AboutMeDetails = () => {
    return (
        <div className="flex flex-col justify-center items-center mt-3 w-screen gap-3">
            ...
            <div className="reveal opacity-0 w-11/12 bg-fuchsia-300 text-center flex flex-col justify-center items-center p-2 
            ...
            <div className="reveal opacity-0 w-11/12 bg-fuchsia-300 text-center flex flex-col justify-center items-center p-2 rounded-md gap-3 border-2 border-fuchsia-700">
