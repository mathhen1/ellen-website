const Experience = () => {
    ...
    const cardXp = "rounded-lg object-fit w-11/12 min-h-[60vh] h-full flex flex-col items-center justify-start bg-fuchsia-400 border-2 border-b-4 border-l-4 overflow-auto flex-shrink-0 snap-center snap-always gap-2 p-3"
